...
const uiEnhancements = {
  en: {
    ...
    checkout: {
      ...
      sleeporaCheckoutTitle: "Sleepora Checkout",
      paypalMethod: "PayPal",
      cardMethod: "Card",
      paypalMethodHint: "Pay quickly with your PayPal account.",
      cardMethodHint: "Pay with Visa or Mastercard through PayPal's secure card form.",
  ...
  fr: {
    ...
    checkout: {
      ...
      sleeporaCheckoutTitle: "Checkout Sleepora",
      paypalMethod: "PayPal",
      cardMethod: "Carte",
      paypalMethodHint: "Payez rapidement avec votre compte PayPal.",
      cardMethodHint: "Payez par Visa ou Mastercard via le formulaire carte securise de PayPal.",
      cardSupportNote: "Vous pouvez payer avec PayPal, Visa ou Mastercard.",
  ...
  ar: {
    ...
    checkout: {
      ...
      secureTitle: "دفع آمن",
      sleeporaCheckoutTitle: "صفحة دفع Sleepora",
      paypalMethod: "PayPal",
      cardMethod: "البطاقة",
      paypalMethodHint: "ادفع بسرعة عبر حساب PayPal الخاص بك.",
      cardMethodHint: "ادفع ببطاقة Visa أو Mastercard عبر نموذج البطاقة الآمن من PayPal.",
